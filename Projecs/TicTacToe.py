...
def draw_board():
    ...
    for row in range(3):
        for col in range(3):
            if board[row][col] == 'X':
                pygame.draw.line(screen, BLACK, (col * 133 + 20, row * 133 + 20), (col * 133 + 113, row * 133 + 113), LINE_WIDTH)
                pygame.draw.line(screen, BLACK, (col * 133 + 20, row * 133 + 113), (col * 133 + 113, row * 133 + 20), LINE_WIDTH)
            elif board[row][col] == 'O':
                pygame.draw.circle(screen, BLACK, (col * 133 + 66, row * 133 + 66), 47, LINE_WIDTH)
